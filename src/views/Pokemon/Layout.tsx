...
export default ({
  ...
  <div className="">
    ...
    <main className="container pokemon-information">
      ...
      {!pokemon ? (
        <span>{getPokemonError.data}</span>
      ) : (
        <>
          ...
          <div className="data">
            ...
            <div className="detailed-information">
              <div className="item bordered">
                <img
                  src="https://archives.bulbagarden.net/media/upload/7/7f/Bag_Items_HGSS_pocket_icon.png"
                  alt={`${
          ...
          <div className="description bordered">
            {isLoadingSpecies ? (
              ...
              <span>{getSpeciesError.data}</span>
            ) : (
              <p>
